...
**Added By:** te215
**Related to:** Flask Web Server, Database
**Link:** [pypi.org python-dotenv/](https://pypi.org/project/python-dotenv/)

### Flask SQLAlchemy - Databases with Python
**Added By:** te215
**Related to:** Flask Web Server, Database
**Link:** [flask-sqlalchemy Docs](https://flask-sqlalchemy.readthedocs.io/en/stable/quickstart/)

### environ vs getenv - Enviroment variables
**Added By:** te215
**Related to:** Flask Web Server, Database
**Link:** [Environ Vs GetEnv - Medium.com](https://medium.com/@levchevajoana/pythons-os-environ-vs-os-getenv-b149e6fdea3c)
